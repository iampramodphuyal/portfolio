    ...
    <div className='w-full'>
        <div>
            ...
            <div className='flex flex-wrap justify-center pt-2'>
                <div className='flex flex-col w-40 p-10 m-6 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52' data-aos="fade-right">
                    <FaPhp className='mx-auto w-20 h-20 hover:text-purple-900'/>
                    <p className='mx-auto text-2xl sm:text-4xl font-semibold'>PhP</p>
                </div>
                <div className='flex flex-col w-40 p-10 m-6 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52' data-aos="fade-down-right">
                    <FaLaravel className='mx-auto w-20 h-20 hover:text-red-500'/>
                    <p className='mx-auto text-2xl sm:text-4xl font-semibold'>Laravel</p>
                </div>
                <div className='flex flex-col w-40 p-10 m-6 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52' data-aos="zoom-in-up">
                    <FaReact className='mx-auto w-20 h-20 hover:text-cyan-500' />
                    <p className='mx-auto text-2xl sm:text-4xl font-semibold'>React.js</p>
                </div>
                <div className='flex flex-col w-40 p-10 m-6 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52' data-aos="zoom-in-down">
                    <DiDjango className='mx-auto w-20 h-20 hover:text-green-500'/>
                    <p className='mx-auto text-2xl sm:text-4xl font-semibold'>Django</p>
                </div>
                <div className='flex flex-col w-40 p-10 m-6 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52' data-aos="fade-down-left">
                    <SiMysql className='mx-auto w-20 h-20 hover:text-orange-500'/>
                    <p className='mx-auto text-2xl sm:text-4xl font-semibold'>MySQL</p>
                </div>
                <div className='flex flex-col w-40 p-10 m-6 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52' data-aos="fade-left">
