...
function Card(){
    ...
    return(
        <div className='w-full'>
            ...
            <div>
                <div className='mt-10 mx-auto max-w-7xl px-4 py-4'>
                    <div className='sm:text-center lg:text-center text-gray-900'>
                        <h1 className='text-4xl text-gray-700 font-extrabold sm:text-5xl md:text-5xl'>
                        ...
                        <h2 className='m-5 text-2xl text-gray-700 font-extrabold sm:text-3xl md:text-3xl'>
            ...
            <div className='mt-10 mx-auto text-center w-1/6'>
                <a href={resume} className=''>
                    <AiOutlineCloudDownload className='mx-auto w-10 h-10'/>
